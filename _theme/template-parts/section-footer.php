    ...
    <div class="_container">
        <div class="content-footer d_flex f_jc_sb">
            <div class="logo-footer">
                <img src="<?bloginfo("template_url")?>/img/logo.svg"" alt="Логотип стильный дом">
            ...
            <div class="footer-nav__panel">
                ...
                <div class="footer-nav__panel-card d_flex f_jc_sb">
                    <img src="<?php echo get_template_directory_uri();?>/img/icons/icon-mirpay.svg" alt="">
                    <img src="<?php echo get_template_directory_uri();?>/img/icons/icon-bank.svg" alt="">
                </div>
            </div>
