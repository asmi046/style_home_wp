<?php get_header(); ?>
    ...
    <?php get_template_part('template-parts/section-uslugi');?>
    <?php get_template_part('template-parts/section-portfolio');?>
    <?php get_template_part('template-parts/section-ceni-pod-cluth');?>
    <?php get_template_part('template-parts/section-dop-uslugi');?>
    <?php get_template_part('template-parts/section-komanda');?>
    <?php get_template_part('template-parts/section-remont-bez-nervov');?>
